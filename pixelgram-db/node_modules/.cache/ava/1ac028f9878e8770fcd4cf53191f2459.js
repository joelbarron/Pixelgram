...
test.afterEach.always('clean up database', (() => {
...
test('like image', (() => {
  var _ref4 = _asyncToGenerator(function* (t) {
    ...
    t.true(_rec4._expr(_rec4._capt(_rec4._capt(result, 'arguments/0/object').liked, 'arguments/0'), {
...
test('get image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/Users/joel_barron/desarrollo/web/repositorios/Pixelgram/pixelgram-db/test/db-test.js', 83), _avaThrowsHelperEnd(t, db.getImage('foo'))), /not found/);
  });
...
test('list all images', (() => {
  var _ref6 = _asyncToGenerator(function* (t) {
    ...
    let created = yield Promise.all(saveImages);
...
test('save user', (() => {
  var _ref7 = _asyncToGenerator(function* (t) {
    ...
    t.is(typeof created.id, 'string');
    t.truthy(_rec5._expr(_rec5._capt(_rec5._capt(created, 'arguments/0/object').createdAt, 'arguments/0'), {
      content: 't.truthy(created.createdAt)',
      filepath: 'test/db-test.js',
      line: 117,
      async: true,
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/Users/joel_barron/desarrollo/web/repositorios/Pixelgram/pixelgram-db/test/db-test.js', 134), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
test('authenticate user', (() => {
  var _ref9 = _asyncToGenerator(function* (t) {
    ...
    t.true(_rec6._expr(_rec6._capt(success, 'arguments/0'), {
    ...
    t.false(_rec7._expr(_rec7._capt(fail, 'arguments/0'), {
    ...
    let failture = yield db.authenticate('foo', 'bar');
    t.false(_rec8._expr(_rec8._capt(failture, 'arguments/0'), {
      content: 't.false(failture)',
      filepath: 'test/db-test.js',
      line: 156,
      async: true,
      ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"false","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"Identifier","name":"failture","range":[8,16]}],"range":[0,17]}',
      tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"false"},"value":"false","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"failture","range":[8,16]},{"type":{"label":")"},"range":[16,17]}]',
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
...
//# sourceMappingURL=../node_modules/.cache/ava/1ac028f9878e8770fcd4cf53191f2459.js.map