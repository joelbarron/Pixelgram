...
test('get image', (() => {
  var _ref5 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/Users/joel_barron/desarrollo/web/repositorios/Pixelgram/pixelgram-db/test/db-test.js', 82), _avaThrowsHelperEnd(t, db.getImage('foo'))), /not found/);
  });
...
test('get user', (() => {
  var _ref8 = _asyncToGenerator(function* (t) {
    ...
    yield t.throws((_avaThrowsHelperStart(t, 'throws', '/Users/joel_barron/desarrollo/web/repositorios/Pixelgram/pixelgram-db/test/db-test.js', 132), _avaThrowsHelperEnd(t, db.getUser('foo'))), /not found/);
  });
...
//# sourceMappingURL=../node_modules/.cache/ava/86b7a432ac3f744cdb7946027a630b42.js.map