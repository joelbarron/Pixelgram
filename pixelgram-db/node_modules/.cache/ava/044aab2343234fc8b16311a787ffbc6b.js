...
test('authenticate user', (() => {
  var _ref9 = _asyncToGenerator(function* (t) {
    ...
    t.is(typeof db.authenticatetUser, 'function', 'authenticate is a fucntion');

    let user = fixtures.getUser();
    let plainPassword = user.password;
    yield db.saveUser(user);

    let success = yield db.authenticatetUser(user.username, plainPassword);
    ...
    let fail = yield db.authenticatetUser(user.username, 'foo');
...
//# sourceMappingURL=../node_modules/.cache/ava/044aab2343234fc8b16311a787ffbc6b.js.map